...
//! It exposes only stable product-contract, lifecycle, and build-tool
//! modules — never A2A-internal Python detail, which stays opaque behind the
//! capsule manifest.
//!
//! Modules delivered so far:
//!
//! Product authority substrate:
