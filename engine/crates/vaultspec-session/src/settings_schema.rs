...
fn build_registry() -> Vec<SettingDef> {
    vec![
        ...
        SettingDef {
            ...
            description: "Minimize animations and transitions across the dashboard.".to_string(),
            group: "Appearance".to_string(),
            order: 2,
            step: None,
            unit: None,
        ...
        SettingDef {
            ...
            scope_eligible: true,
            control: ControlKind::Segmented,
            label: "Default detail level".to_string(),
            description: "The graph level of detail to open with for this scope.".to_string(),
