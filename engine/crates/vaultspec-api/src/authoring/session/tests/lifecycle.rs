//! Session, prompt-turn, queue, cancellation, close, listing, and recovery
//! behaviour. Fixtures come from the parent module.
...
fn proposal_creation_rejects_unknown_session_id() {
    ...
    let err = crate::authoring::proposal::create_proposal(
        &mut store,
        &reader,
