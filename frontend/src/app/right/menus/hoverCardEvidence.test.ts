...
// group bounding ("+N more"), the empty-group omission, the resolution-state pass-
// through, and the path → file-name compaction.
...
describe("deriveEvidenceGroups", () => {
  it("omits empty groups entirely (no empty 'code' section)", () => {
