    ...
    expect(view.rowGroups).toEqual([
      {
        ...
        rows: [
          expect.objectContaining({
            ...
            rowClassName:
              "flex h-[1.875rem] w-full items-center justify-between rounded-fg-md px-fg-2 text-left transition-colors duration-ui-fast ease-settle bg-accent-subtle text-ink",
