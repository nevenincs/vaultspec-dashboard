...
import { EXPECTED_DOCUMENT_KEYS } from "./catalogDocumentKeys";
...
const EXPECTED_AGENT_SERVICE_KEYS = [
  "common:agentService.description",
  "common:agentService.statusLabel",
  "common:agentService.sections.status",
  "common:agentService.sections.orchestration",
  "common:agentService.sections.actions",
  "common:agentService.sections.diagnostics",
  "common:agentService.installState.absent",
  "common:agentService.installState.settled",
  "common:agentService.installState.recoveryRequired",
  "common:agentService.installState.busy",
  "common:agentService.installState.unverifiable",
  "common:agentService.installState.unknown",
  "common:agentService.readiness.uninstalled",
  "common:agentService.readiness.stopped",
  "common:agentService.readiness.running",
  "common:agentService.readiness.workerIdle",
  ...
  "common:agentService.ops.install",
  "common:agentService.ops.ensure",
  "common:agentService.ops.start",
  "common:agentService.ops.stop",
  "common:agentService.ops.restart",
  "common:agentService.ops.repair",
  "common:agentService.ops.update",
  "common:agentService.ops.rollback",
  "common:agentService.ops.remove",
  ...
  "common:agentService.confirm.remove.title",
  "common:agentService.confirm.remove.body",
  "common:agentService.confirm.remove.confirmLabel",
  "common:agentService.confirm.remove.cancelLabel",
  "common:agentService.confirm.rollback.title",
  "common:agentService.confirm.rollback.body",
  "common:agentService.confirm.rollback.confirmLabel",
  "common:agentService.confirm.rollback.cancelLabel",
] as const;

const EXPECTED_CATALOG_KEYS = [
  ...EXPECTED_AGENT_SERVICE_KEYS,
  ...EXPECTED_SHELL_KEYS,
  ...
  "common:actions.open",
  "common:actions.openAdvancedSettings",
  ...
  "common:advanced.title",
  "common:advanced.description",
  "common:advanced.labels.projectHealth",
  "common:advanced.labels.systemStatus",
  "common:advanced.labels.agentService",
  "common:advanced.accessibility.group",
  "common:advanced.accessibility.panelStatus",
  "common:advanced.tones.workingNormally",
  "common:advanced.tones.needsAttention",
  "common:advanced.tones.unavailable",
  "common:advanced.tones.checking",
  ...EXPECTED_AGENT_KEYS,
  ...
  "documents:accessibility.featurePlansFinished",
  "documents:accessibility.featurePlansInProgress",
  "documents:accessibility.featurePlansNotStarted",
  ...
  "documents:codeTree.ignored.git",
  "documents:codeTree.ignored.rag",
  ...
  "documents:codeTree.states.statusTruncated",
  "documents:codeTree.states.truncated",
  "documents:codeTree.states.truncatedUnknown",
  "documents:codeTree.status.badge.added",
  "documents:codeTree.status.badge.conflicted",
  "documents:codeTree.status.badge.deleted",
  "documents:codeTree.status.badge.modified",
  "documents:codeTree.status.badge.renamed",
  "documents:codeTree.status.badge.untracked",
  "documents:codeTree.status.label.added",
  "documents:codeTree.status.label.conflicted",
  "documents:codeTree.status.label.deleted",
  "documents:codeTree.status.label.modified",
  "documents:codeTree.status.label.renamed",
  "documents:codeTree.status.label.untracked",
  ...
  "documents:editor.advisories.label",
  "documents:editor.advisories.fixable",
  "documents:editor.statuses.saved",
  "documents:editor.statuses.unsaved",
  "documents:editor.statuses.saving",
  "documents:editor.statuses.saveFailed",
  "documents:editor.statuses.conflict",
  ...
  "projects:provisioning.details.addProjectFiles",
  "projects:provisioning.details.installProjectTools",
  "projects:provisioning.details.installRequiredProjectTools",
  "projects:provisioning.details.prepareFolderAsGitProject",
  "projects:provisioning.details.updateProjectFiles",
  "projects:provisioning.details.updateProjectTools",
  ...
  "projects:provisioning.titles.notAGitProject",
  ...
  "settings:fields.codeTreeFileIcons.description",
  "settings:fields.codeTreeFileIcons.label",
...
const EXPECTED_PUBLIC_MESSAGE_KEYS = [
  ...
  "documents:tree.featureAuditCount",
  "documents:tree.featureDecisionCount",
  "documents:tree.featurePlanCount",
  "documents:tree.featureReferenceCount",
  "documents:tree.featureResearchCount",
  "documents:tree.featureStepCount",
