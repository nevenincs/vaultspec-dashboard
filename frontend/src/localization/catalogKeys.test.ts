...
const EXPECTED_CATALOG_KEYS = [
  ...
  "documents:reviewStation.actions.signInAsReviewer",
  "documents:reviewStation.actions.signOut",
  ...
  "documents:reviewStation.states.signedIn",
  "documents:reviewStation.states.signingIn",
