...
export const ENGLISH_MESSAGE_POLICY = {
  ...
  "common:actions.openAdvancedSettings": { role: "action" },
  ...
  "common:changeBuckets.staged": { role: "label" },
  ...
  "documents:accessibility.featurePlansFinished": { role: "accessibility" },
  "documents:accessibility.featurePlansInProgress": { role: "accessibility" },
  "documents:accessibility.featurePlansNotStarted": { role: "accessibility" },
  ...
  "documents:editor.advisories.label": { role: "label" },
  "documents:editor.advisories.fixable": { role: "label" },
  "documents:editor.statuses.saved": { role: "status" },
  "documents:editor.statuses.unsaved": { role: "status" },
  "documents:editor.statuses.saving": { role: "status" },
  "documents:editor.statuses.saveFailed": { role: "status" },
  ...
  "documents:actions.nextChange": { role: "action" },
  "documents:actions.nextTab": { role: "action" },
  "documents:actions.openComments": { role: "action" },
  "documents:actions.previousChange": { role: "action" },
  ...
  "documents:actions.showOrHideMetadata": { role: "action" },
  ...
  "documents:reviewStation.policy.assistedReviewerApproval": { role: "label" },
  ...
  "documents:reviewStation.policy.autonomousReviewerApproval": { role: "label" },
  ...
  "documents:reviewStation.policy.manualReviewerApproval": { role: "label" },
  ...
  // The feature row's served metadata: counted composition parts, the compact
  // date-span join, and the two spelled-out sentences that name what the span
  // MEANS for assistive tech (a bare date pair on a feature row states nothing).
  "documents:tree.featureAuditCount": { role: "label" },
  "documents:tree.featureDateRange": { role: "label" },
  "documents:tree.featureDecisionCount": { role: "label" },
  "documents:tree.featureDecisionDate": { role: "accessibility" },
  "documents:tree.featureDecisionSpan": { role: "accessibility" },
  "documents:tree.featurePlanCount": { role: "label" },
  "documents:tree.featureReferenceCount": { role: "label" },
  "documents:tree.featureResearchCount": { role: "label" },
  "documents:tree.featureStepCount": { role: "label" },
  ...
  "projects:provisioning.details.addProjectFiles": { role: "description" },
  "projects:provisioning.details.installProjectTools": { role: "description" },
  ...
  "projects:provisioning.details.updateProjectFiles": { role: "description" },
  "projects:provisioning.details.updateProjectTools": { role: "description" },
  ...
  "projects:provisioning.titles.setUpRequired": { role: "label" },
  "projects:provisioning.titles.toolsMissing": { role: "label" },
  "projects:provisioning.titles.toolsUpdateRequired": { role: "label" },
  "projects:provisioning.titles.updateRequired": { role: "label" },
