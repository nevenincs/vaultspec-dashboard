...
export const ENGLISH_MESSAGE_POLICY = {
  ...
  "common:controlPanels.accessibility.pending": { role: "accessibility" },
  "common:controlPanels.accessibility.pendingNone": { role: "accessibility" },
  "common:advanced.title": { role: "label" },
  "common:advanced.description": { role: "description" },
  "common:advanced.openServiceConsole": { role: "action" },
  "common:advanced.consoles.service": { role: "label" },
  "common:advanced.consoles.engine": { role: "label" },
  "common:advanced.consoles.agent": { role: "label" },
