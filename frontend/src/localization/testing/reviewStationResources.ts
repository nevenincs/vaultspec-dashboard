...
export const ltrReviewStationResources = {
  ...
  diffstat: {
    ...
    editedFiles_one: "{{count, number}} fichier modifié",
    editedFiles_many: "{{count, number}} de fichiers modifiés",
    editedFiles_other: "{{count, number}} fichiers modifiés",
    floorMarker: "Ou plus",
...
export const rtlReviewStationResources = {
  ...
  diffstat: {
    ...
    editedFiles_zero: "تم تعديل {{count, number}} ملف",
    editedFiles_one: "تم تعديل {{count, number}} ملف واحد",
    editedFiles_two: "تم تعديل {{count, number}} ملفين",
    editedFiles_few: "تم تعديل {{count, number}} ملفات",
    editedFiles_many: "تم تعديل {{count, number}} ملفًا",
    editedFiles_other: "تم تعديل {{count, number}} ملف",
    floorMarker: "أو أكثر",
    removed: "−{{lines, number}}",
  },
  actions: {
