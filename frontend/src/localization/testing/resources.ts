...
export const ltrTestResources = {
  ...
  documents: {
    ...
    tree: {
      ...
      featureAuditCount_one: "{{count, number}} audit",
      featureAuditCount_many: "{{count, number}} audits",
      featureAuditCount_other: "{{count, number}} audits",
      featureDateRange: "{{first}} – {{last}}",
      featureDecisionCount_one: "{{count, number}} décision",
      featureDecisionCount_many: "{{count, number}} décisions",
      featureDecisionCount_other: "{{count, number}} décisions",
      featureDecisionDate: "Décisions datées du {{date}}",
      featureDecisionSpan: "Décisions du {{first}} au {{last}}",
      featurePlanCount_one: "{{count, number}} plan",
      featurePlanCount_many: "{{count, number}} plans",
      featurePlanCount_other: "{{count, number}} plans",
      featureReferenceCount_one: "{{count, number}} référence",
      featureReferenceCount_many: "{{count, number}} références",
      featureReferenceCount_other: "{{count, number}} références",
      featureResearchCount_one: "{{count, number}} note de recherche",
      featureResearchCount_many: "{{count, number}} notes de recherche",
      featureResearchCount_other: "{{count, number}} notes de recherche",
      featureStepCount_one: "{{count, number}} relevé d’étape",
      featureStepCount_many: "{{count, number}} relevés d’étape",
      featureStepCount_other: "{{count, number}} relevés d’étape",
...
export const rtlTestResources = {
  ...
  documents: {
    ...
    tree: {
      ...
      featureAuditCount_one: "{{count, number}} تدقيق",
      featureAuditCount_zero: "{{count, number}} تدقيق",
      featureAuditCount_two: "{{count, number}} تدقيقان",
      featureAuditCount_few: "{{count, number}} تدقيقات",
      featureAuditCount_many: "{{count, number}} تدقيقًا",
      featureAuditCount_other: "{{count, number}} تدقيق",
      featureDateRange: "{{first}} – {{last}}",
      featureDecisionCount_one: "{{count, number}} قرار",
      featureDecisionCount_zero: "{{count, number}} قرار",
      featureDecisionCount_two: "{{count, number}} قراران",
      featureDecisionCount_few: "{{count, number}} قرارات",
      featureDecisionCount_many: "{{count, number}} قرارًا",
      featureDecisionCount_other: "{{count, number}} قرار",
      featureDecisionDate: "قرارات بتاريخ {{date}}",
      featureDecisionSpan: "قرارات من {{first}} إلى {{last}}",
      featurePlanCount_one: "{{count, number}} خطة",
      featurePlanCount_zero: "{{count, number}} خطة",
      featurePlanCount_two: "{{count, number}} خطتان",
      featurePlanCount_few: "{{count, number}} خطط",
      featurePlanCount_many: "{{count, number}} خطة",
      featurePlanCount_other: "{{count, number}} خطة",
      featureReferenceCount_one: "{{count, number}} مرجع",
      featureReferenceCount_zero: "{{count, number}} مرجع",
      featureReferenceCount_two: "{{count, number}} مرجعان",
      featureReferenceCount_few: "{{count, number}} مراجع",
      featureReferenceCount_many: "{{count, number}} مرجعًا",
      featureReferenceCount_other: "{{count, number}} مرجع",
      featureResearchCount_one: "{{count, number}} ملاحظة بحثية",
      featureResearchCount_zero: "{{count, number}} ملاحظة بحثية",
      featureResearchCount_two: "{{count, number}} ملاحظتان بحثيتان",
      featureResearchCount_few: "{{count, number}} ملاحظات بحثية",
      featureResearchCount_many: "{{count, number}} ملاحظة بحثية",
      featureResearchCount_other: "{{count, number}} ملاحظة بحثية",
      featureStepCount_one: "{{count, number}} سجل خطوة",
      featureStepCount_zero: "{{count, number}} سجل خطوة",
      featureStepCount_two: "{{count, number}} سجلا خطوة",
      featureStepCount_few: "{{count, number}} سجلات خطوات",
      featureStepCount_many: "{{count, number}} سجل خطوة",
      featureStepCount_other: "{{count, number}} سجل خطوة",
