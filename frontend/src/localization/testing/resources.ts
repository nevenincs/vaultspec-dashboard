...
import { ltrAgentResources, rtlAgentResources } from "./agentResources";
import {
...
import { ltrSettingsResources, rtlSettingsResources } from "./settingsResources";
...
export const ltrTestResources = {
  common: {
    ...
    changes: ltrCS.changes,
    finalWave: ltrCS.finalWave,
    freshness: ltrCS.freshness,
    kit: ltrCS.kit,
    rail: ltrCS.rail,
    shell: ltrCS.shell,
    actions: {
...
export const rtlTestResources = {
  common: {
    ...
    changes: rtlCS.changes,
    finalWave: rtlCS.finalWave,
    freshness: rtlCS.freshness,
    kit: rtlCS.kit,
    rail: rtlCS.rail,
    shell: rtlCS.shell,
    actions: {
