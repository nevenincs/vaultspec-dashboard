export const projects = {
  ...
  workspaceIdentity: {
    accessibility: {
      choose: "Choose a project or worktree",
      currentLocation: "Current location: {{worktree}}",
      currentLocationInProject: "Current location: {{worktree}} in {{project}}",
      currentLocationSwitching: "Current location: {{worktree}}. Switching.",
      currentLocationSwitchingInProject:
        "Current location: {{worktree}} in {{project}}. Switching.",
      recentProjects: "Recent projects",
      removeRecent: "Remove {{worktree}} from history",
      rowActions: "Actions for {{worktree}}",
      switchProject: "Switch to project {{project}}",
      switchWorktree: "Switch to worktree {{worktree}}",
      switchWorktreeInProject: "Switch to {{worktree}} in {{project}}",
      switchUnnamedWorktreeInProject: "Switch to a worktree in {{project}}",
      unavailableProject: "Project unavailable",
      unavailableWorktree: "{{worktree}} cannot be opened",
      worktreeList: "Projects and worktrees",
    },
    actions: {
    ...
    counts: {
      ahead_one: "{{count, number}} commit ahead",
      ahead_other: "{{count, number}} commits ahead",
      behind_one: "{{count, number}} commit behind",
      behind_other: "{{count, number}} commits behind",
    },
    descriptions: {
      switchProject: "Choose a recent project or worktree.",
    },
    labels: {
      current: "Current",
      default: "Default",
      noProjectName: "Unnamed project",
      noWorktreeName: "Worktree",
      noProjectFiles: "Unavailable",
      switching: "Switching…",
      uncommittedChanges: "Uncommitted changes",
      thisProjectWorktrees: "This project’s worktrees",
      unnamedWorktreeInProject: "Worktree in {{project}}",
      worktreeInProject: "{{worktree}} in {{project}}",
      worktreesInProject: "Worktrees in {{project}}",
    },
    sections: {
      projects: "Projects",
      recent: "Recent",
    ...
    states: {
      degraded: "Some worktrees are unavailable. Showing available worktrees.",
      loading: "Loading worktrees…",
      noRecent: "No recent projects. Open a project to get started.",
      noWorktrees: "No worktrees are available. Add a project to continue.",
      noWorktreesWithProjectFiles:
        "These worktrees cannot be opened. Choose another project.",
      onlyWorktree: "This is the only available worktree.",
      switchFailed: "Couldn’t switch worktrees. Try again.",
      worktreesFailed: "Worktrees couldn’t be loaded. Try again.",
    },
    titles: {
