...
export const documents = {
  ...
  reviewStation: {
    ...
    policy: {
      ...
      assistedReviewerApproval: "Assisted, reviewer approval",
      assistedSystemApproval: "Assisted, automatic approval",
      autonomousHumanApproval: "Autonomous, reviewer approval",
      autonomousReviewerApproval: "Autonomous, reviewer approval",
      autonomousSystemApproval: "Autonomous, automatic approval",
      manualHumanApproval: "Manual, human approval required",
      manualReviewerApproval: "Manual, reviewer approval",
