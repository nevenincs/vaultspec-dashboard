...
export const documents = {
  ...
  accessibility: {
    ...
    featurePlansFinished: "Plans finished",
    featurePlansInProgress: "Plans in progress",
    featurePlansNotStarted: "Plans not started",
  ...
  tree: {
    ...
    featureDecisionCount_one: "{{count, number}} decision",
    featureDecisionCount_other: "{{count, number}} decisions",
    featureDecisionDate: "Decisions dated {{date}}",
    featureDecisionSpan: "Decisions from {{first}} to {{last}}",
    featurePlanCount_one: "{{count, number}} plan",
    featurePlanCount_other: "{{count, number}} plans",
    featureReferenceCount_one: "{{count, number}} reference",
    featureReferenceCount_other: "{{count, number}} references",
    featureResearchCount_one: "{{count, number}} research note",
    featureResearchCount_other: "{{count, number}} research notes",
    featureStepCount_one: "{{count, number}} step record",
    featureStepCount_other: "{{count, number}} step records",
