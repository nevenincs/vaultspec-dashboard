...
describe("copy verb", () => {
  ...
  it("resolves every canonical copy label through the real localization runtime", () => {
    ...
    const cases = [
      ...
      ["common:actions.copyCommitHash", "Copy commit hash"],
      ["common:actions.copyCommitMessage", "Copy commit message"],
      ...
      ["common:actions.copyPullRequestLink", "Copy pull request link"],
      ["common:actions.copyPullRequestNumber", "Copy pull request number"],
      ["common:actions.copyShortCommitHash", "Copy short commit hash"],
