...
<!-- FRONTMATTER RULES:
     ...
     Replace rag-console-review with a kebab-case feature tag, e.g. #foo-bar.
...
- [ ] `P02.S05` - RCR-002 (Tier-3): file the rag coordination ask for machine-wide aggregate storage totals on /storage/survey; `coordination note (rag sibling)`.
