...
- [x] `W02.P06.S221` - Move rail-sort labels into canonical catalog mappings; `frontend/src/stores/view/railSort.ts, frontend/src/stores/view/railSort.test.ts, frontend/src/stores/view/leftRailKeybindings.ts, frontend/src/app/left/BrowserRegion.tsx, frontend/src/app/left/BrowserRegion.render.test.tsx, frontend/src/locales/en/documents.ts, frontend/src/localization/testing/resources.ts, frontend/src/localization/catalogKeys.test.ts, frontend/src/localization/messagePolicy.ts, frontend/scripts/localization-allowlist.json`.
