...
- [ ] `W05.P11.S71` - Run the code-review audit over the timeline build; `.vault/audit/2026-06-15-dashboard-timeline-audit.md`.
- [ ] `W05.P11.S72` - Perform visual and manual in-browser verification of the timeline surface; `frontend/src/app/timeline/Timeline.tsx`.
- [ ] `W05.P11.S73` - Run the codify check for durable cross-session lessons; `.vault/audit/2026-06-15-dashboard-timeline-audit.md`.
