...
<!-- FRONTMATTER RULES:
     ...
     The S15 and 2026-06-14-dashboard-activity-rail-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Extend the rail unit tests to assert the RAIL_TABS strip is exactly now, work, changes, search in that order and ## Scope
