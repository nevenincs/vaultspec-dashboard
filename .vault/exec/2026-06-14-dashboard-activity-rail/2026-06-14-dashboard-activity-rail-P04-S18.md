...
<!-- FRONTMATTER RULES:
     ...
     The S18 and 2026-06-14-dashboard-activity-rail-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add a WorkTab render test asserting the degraded state derives from the tiers truth and not from a bare transport error and ## Scope
