...
<!-- FRONTMATTER RULES:
     ...
     The S08 and 2026-06-14-dashboard-activity-rail-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Render a designed empty state in WorkTab for the available-but-no-work case stating no in-flight pipeline work in the current scope and ## Scope
