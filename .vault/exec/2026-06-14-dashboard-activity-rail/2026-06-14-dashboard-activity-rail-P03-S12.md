...
<!-- FRONTMATTER RULES:
     ...
     The S12 and 2026-06-14-dashboard-activity-rail-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Confirm the work tab button carries role=tab and aria-selected reflecting the active tab like the other three tabs and ## Scope
