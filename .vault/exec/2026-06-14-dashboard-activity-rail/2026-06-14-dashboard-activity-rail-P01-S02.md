...
<!-- FRONTMATTER RULES:
     ...
     The S02 and 2026-06-14-dashboard-activity-rail-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Extend the ActivityRail tab state union type to include the work tab id alongside activity, changes, and search and ## Scope
