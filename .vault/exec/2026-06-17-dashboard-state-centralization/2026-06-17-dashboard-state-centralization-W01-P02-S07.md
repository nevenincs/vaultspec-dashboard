...
<!-- FRONTMATTER RULES:
     ...
     The S07 and 2026-06-17-dashboard-state-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Register the dashboard-state route in the API routes module and ## Scope
