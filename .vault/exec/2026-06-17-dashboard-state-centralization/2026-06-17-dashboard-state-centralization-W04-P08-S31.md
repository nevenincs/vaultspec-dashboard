...
<!-- FRONTMATTER RULES:
     ...
     The S31 and 2026-06-17-dashboard-state-centralization-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Remove the unfiltered availability graph query and derive availability from the held canonical slice and ## Scope
