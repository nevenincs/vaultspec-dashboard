...
date: '2026-07-17'
modified: '2026-07-17'
body_hash: 'sha256:d6022be7c59500814585e0a580d5612c8f62a8248cd35f1690d4a0c68bfde816'
step_id: 'S144'
related:
...
uncontended `18/18` reruns of `2890e92df6`, plus the fold/scroll/menu-close
fixes cited against the actual diff; the cold-state gap remains tracked as
the finisher's own open punch-list item, which does NOT unverify this step's
...
`18/18` reruns of `2890e92df6`, the fold/scroll/menu-close fixes) stands
...
`2890e92df6`, the fold/scroll/menu-close fixes) is unchanged and is what the
