...
<!-- FRONTMATTER RULES:
     ...
     The S03 and 2026-06-16-status-overview-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Build StatusTab (location anchor + open plans w/ step-tree expand + open-in-viewer + recent commits), wire into rail IA and ## Scope
