...
<!-- FRONTMATTER RULES:
     ...
     The S14 and 2026-06-14-node-visual-richness-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The add a hover-id view slice and handle the hover scene event in the stage and ## Scope
