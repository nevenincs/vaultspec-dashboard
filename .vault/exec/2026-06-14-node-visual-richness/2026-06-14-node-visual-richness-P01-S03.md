...
<!-- FRONTMATTER RULES:
     ...
     The S03 and 2026-06-14-node-visual-richness-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The echo the status fields through the query route envelope with the tiers block and ## Scope

- `engine/crates/vaultspec-api/src/routes/query.rs` placeholders below are machine-filled
     by `vaultspec-core vault add exec` from the originating Step row;
     do not fill them by hand. -->

# echo the status fields through the query route envelope with the tiers block
