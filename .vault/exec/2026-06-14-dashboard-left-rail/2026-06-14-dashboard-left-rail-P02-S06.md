...
<!-- FRONTMATTER RULES:
     ...
     The S06 and 2026-06-14-dashboard-left-rail-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Re-key the chosen mode per scope and wire it into the wholesale reset and ## Scope
