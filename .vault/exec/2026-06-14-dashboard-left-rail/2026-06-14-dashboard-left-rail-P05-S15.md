...
<!-- FRONTMATTER RULES:
     ...
     The S15 and 2026-06-14-dashboard-left-rail-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Prove per-scope mode and filter reset with no cross-scope bleed and ## Scope
