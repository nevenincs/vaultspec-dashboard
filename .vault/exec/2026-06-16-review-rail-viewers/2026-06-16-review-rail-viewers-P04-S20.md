...
<!-- FRONTMATTER RULES:
     ...
     The S20 and 2026-06-16-review-rail-viewers-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Override fenced code rendering to delegate to the shared useHighlighter hook so reader fences and the code viewer share one tokenizer and ## Scope
