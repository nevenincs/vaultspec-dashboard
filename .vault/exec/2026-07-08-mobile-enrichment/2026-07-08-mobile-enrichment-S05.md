...
<!-- FRONTMATTER RULES:
     ...
     The S05 and 2026-07-08-mobile-enrichment-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add a live-engine compact guard test asserting the ADR-status word and date render inline (the tooltip-only regression is otherwise silent) and ## Scope

- `frontend/src/app/left/VaultBrowser.compact.render.test.tsx` placeholders below are machine-filled
