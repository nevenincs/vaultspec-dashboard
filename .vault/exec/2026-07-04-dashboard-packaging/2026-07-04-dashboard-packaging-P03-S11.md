...
date: '2026-07-04'
modified: '2026-07-30'
body_hash: 'sha256:2090f822708b0b245b119f75e0841564292beade49b1ac8d4126b148f8a80cdd'
step_id: 'S11'
related:
...
- Review revision: `engine/Cargo.toml` `repository` was corrected to `github.com/nevenincs/vaultspec-dashboard` - releases publish to the repo the workflow runs in (nevenincs, matching origin and the README), and dist derives installer download URLs from this field, so the old metadata handle's value would have 404'd both installer one-liners at the first tag. User veto welcome if the previous account is the intended public home.
