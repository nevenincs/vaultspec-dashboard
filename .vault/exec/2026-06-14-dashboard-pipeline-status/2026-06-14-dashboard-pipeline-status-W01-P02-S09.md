...
<!-- FRONTMATTER RULES:
     ...
     The S09 and 2026-06-14-dashboard-pipeline-status-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add the usePipelineStatusView hook that wires usePipelineStatus into derivePipelineStatusView, reading tiers from data then the EngineError envelope, so the Work surface consumes interpreted truth and never the raw tiers block and ## Scope
