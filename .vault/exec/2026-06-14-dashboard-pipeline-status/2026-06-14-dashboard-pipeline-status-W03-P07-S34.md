...
<!-- FRONTMATTER RULES:
     ...
     The S34 and 2026-06-14-dashboard-pipeline-status-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Emit step navigation intent on activating a step row, calling selectNode with the step's bound exec-record node id so selecting a step jumps to its exec record through the same selection seam and ## Scope
