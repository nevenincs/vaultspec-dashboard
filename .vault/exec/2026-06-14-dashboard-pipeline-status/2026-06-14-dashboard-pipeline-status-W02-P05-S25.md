...
<!-- FRONTMATTER RULES:
     ...
     The S25 and 2026-06-14-dashboard-pipeline-status-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Render the degraded state from the selector's interpreted degraded flag (pipeline tier absent or unavailable) as a designed advisory notice, never guessed from a transport error and ## Scope
