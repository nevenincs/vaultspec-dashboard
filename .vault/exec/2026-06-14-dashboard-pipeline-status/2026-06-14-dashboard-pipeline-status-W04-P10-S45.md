...
<!-- FRONTMATTER RULES:
     ...
     The S45 and 2026-06-14-dashboard-pipeline-status-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add a grayscale-safe gate test asserting the ProgressRing, StatusPill, and step check mark stay distinct by shape and text at 14px with hue removed and ## Scope
