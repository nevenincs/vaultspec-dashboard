...
<!-- FRONTMATTER RULES:
     ...
     The S04 and 2026-06-14-dashboard-pipeline-status-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add the EngineClient pipelineStatus method that GETs the bounded in-flight pipeline projection for a scope and as-of and adapts the envelope through liveAdapters and ## Scope
