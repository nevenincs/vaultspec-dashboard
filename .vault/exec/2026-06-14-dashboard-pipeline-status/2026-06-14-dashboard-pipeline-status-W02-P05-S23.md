...
<!-- FRONTMATTER RULES:
     ...
     The S23 and 2026-06-14-dashboard-pipeline-status-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Render the ADR row as a leaf (no step tree): title, the StatusPill reading the real ADR-status facet, feature, and a freshness stamp and ## Scope
