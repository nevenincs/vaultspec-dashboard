...
<!-- FRONTMATTER RULES:
     ...
     The S18 and 2026-06-14-dashboard-pipeline-status-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Replace the WorkTab frame body with the in-flight work list shell that consumes usePipelineStatusView for the active scope and maps each artifact to a row keyed on its stable node id for object constancy and ## Scope
