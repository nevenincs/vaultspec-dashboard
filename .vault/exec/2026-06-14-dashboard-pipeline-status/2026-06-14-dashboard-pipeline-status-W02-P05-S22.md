...
<!-- FRONTMATTER RULES:
     ...
     The S22 and 2026-06-14-dashboard-pipeline-status-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add the grayscale-safe StatusPill component rendering the ADR status as a word-first pill (proposed / accepted / deprecated) with hue as redundant reinforcement only and ## Scope
