...
<!-- FRONTMATTER RULES:
     ...
     The S37 and 2026-06-14-dashboard-pipeline-status-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Fade rows in/out on add/remove with stable ids for object constancy and render keyboard-initiated and reduced-motion paths instantly, reusing the existing animated-transitions grammar without introducing a new motion grammar and ## Scope
