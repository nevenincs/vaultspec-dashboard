...
<!-- FRONTMATTER RULES:
     ...
     The S43 and 2026-06-14-dashboard-pipeline-status-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add render tests asserting the expandable step tree shows rolled-up completion and checked/unchecked marks and renders honest truncation when the interior is capped and ## Scope
