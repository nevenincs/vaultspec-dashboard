...
<!-- FRONTMATTER RULES:
     ...
     The S21 and 2026-06-14-dashboard-pipeline-status-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Render the plan-level progress against the existing lifecycle.progress facet as the derivable-today fallback so the plan row's ring lights up before the full pipeline projection lands, per the staged-capability degradation and ## Scope
