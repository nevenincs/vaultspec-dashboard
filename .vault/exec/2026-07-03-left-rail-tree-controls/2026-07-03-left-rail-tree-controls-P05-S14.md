...
<!-- FRONTMATTER RULES:
     ...
     The S14 and 2026-07-03-left-rail-tree-controls-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Display the corpus-weight percent on feature rows under the weight sort, byte-size leaf meta, and verify compact-viewport parity live at phone width and ## Scope
