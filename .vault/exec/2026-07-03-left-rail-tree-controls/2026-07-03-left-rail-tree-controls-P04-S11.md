...
<!-- FRONTMATTER RULES:
     ...
     The S11 and 2026-07-03-left-rail-tree-controls-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Vertical indent guide lines on `[data-vault-folder-body]`: 1px border-ink line per level at the rows' rem indent math, theme-aware token color and ## Scope
