...
<!-- FRONTMATTER RULES:
     ...
     The S36 and 2026-07-18-a2a-product-provisioning-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Issue and revoke run-scoped token bundles only for the bounded server-validated required-role set returned by prepare, without storing raw secrets or revoking another run for the same actor and ## Scope
