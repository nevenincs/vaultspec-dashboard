...
<!-- FRONTMATTER RULES:
     ...
     The S101 and 2026-07-18-a2a-product-provisioning-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Mount the A2A lifecycle panel only while its modal is open so closed panels perform no service reads and ## Scope
