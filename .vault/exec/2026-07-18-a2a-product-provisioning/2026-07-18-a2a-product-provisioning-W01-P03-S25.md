...
<!-- FRONTMATTER RULES:
     ...
     The S25 and 2026-07-18-a2a-product-provisioning-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Register the lifecycle route acceptance suite in the API test module and ## Scope

- `engine/crates/vaultspec-api/src/lib_tests/mod.rs` placeholders below are machine-filled
