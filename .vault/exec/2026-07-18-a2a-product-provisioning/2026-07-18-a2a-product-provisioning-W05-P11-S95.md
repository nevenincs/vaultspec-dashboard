...
<!-- FRONTMATTER RULES:
     ...
     The S95 and 2026-07-18-a2a-product-provisioning-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Prove the frontend lifecycle client drives the spawned engine and real A2A desktop capsule without a direct sibling request and ## Scope

- `frontend/src/stores/server/a2aLifecycle.live.test.ts` placeholders below are machine-filled
