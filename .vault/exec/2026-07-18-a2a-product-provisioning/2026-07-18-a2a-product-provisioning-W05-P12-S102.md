...
<!-- FRONTMATTER RULES:
     ...
     The S102 and 2026-07-18-a2a-product-provisioning-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Prove lifecycle queries mount only with the agent-service dialog and localization changes preserve panel identity and ## Scope

- `frontend/src/app/panels/ControlPanels.guard.test.tsx` placeholders below are machine-filled
