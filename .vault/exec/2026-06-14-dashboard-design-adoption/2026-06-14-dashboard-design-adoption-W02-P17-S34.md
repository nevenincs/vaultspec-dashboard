...
<!-- FRONTMATTER RULES:
     ...
     The S34 and 2026-06-14-dashboard-design-adoption-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Author the lifecycle state marks in-family from Phosphor primitives honoring the active-versus-node-feature and broken-bolt collision constraints, each passing the 14px grayscale gate and ## Scope
