...
<!-- FRONTMATTER RULES:
     ...
     The S26 and 2026-06-14-dashboard-design-adoption-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Re-skin the canvas controls to consume only the new semantic tokens and Lucide chrome per its accepted surface ADR, preserving layer ownership, with design review and the full lint gate green and ## Scope

- `frontend/src/app/stage/AlgorithmPanel.tsx` placeholders below are machine-filled
