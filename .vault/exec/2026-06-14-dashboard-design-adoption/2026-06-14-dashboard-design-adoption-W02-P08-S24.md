...
<!-- FRONTMATTER RULES:
     ...
     The S24 and 2026-06-14-dashboard-design-adoption-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Re-skin the search surface to consume only the new semantic tokens and sanctioned icons per its accepted surface ADR, preserving layer ownership, with design review and the full lint gate green and ## Scope
