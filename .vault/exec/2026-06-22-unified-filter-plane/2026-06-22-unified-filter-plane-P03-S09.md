...
<!-- FRONTMATTER RULES:
     ...
     The S09 and 2026-06-22-unified-filter-plane-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Retire the canvas-local visibility seam: remove graphCategoryVisibility.ts, the hiddenCategories view-store slice, and the scene compose step in dashboardFilterChoices.ts and ## Scope
