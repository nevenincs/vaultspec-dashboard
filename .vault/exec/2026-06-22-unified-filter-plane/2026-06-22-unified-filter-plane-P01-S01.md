...
<!-- FRONTMATTER RULES:
     ...
     The S01 and 2026-06-22-unified-filter-plane-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Widen GET /graph/asof to accept and apply the canonical Filter, replacing the hardcoded Filter::default(), with validation and the tiers envelope unchanged and ## Scope
