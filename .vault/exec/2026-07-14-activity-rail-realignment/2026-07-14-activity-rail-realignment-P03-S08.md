...
<!-- FRONTMATTER RULES:
     ...
     The S08 and 2026-07-14-activity-rail-realignment-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Build the four modal control panels over the Dialog primitive gated on the open-state store - re-mount RagOpsConsoleBody and ReviewStationSection bodies, mount the host once in the shell and ## Scope

- `frontend/src/app/panels/ControlPanels.tsx` placeholders below are machine-filled
