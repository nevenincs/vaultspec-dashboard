...
<!-- FRONTMATTER RULES:
     ...
     The S12 and 2026-07-14-activity-rail-realignment-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Join the cluster to the compact unified rail footer and verify the panels open compact-safe and ## Scope

- `frontend/src/app/shell/CompactUnifiedRail.tsx` placeholders below are machine-filled
