...
<!-- FRONTMATTER RULES:
     ...
     The S53 and 2026-06-16-figma-parity-reconciliation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rebuild the Layout control to the binding Network, Tree, Grouped, and Timeline modes over the preserved layout-mode catalog and ## Scope
