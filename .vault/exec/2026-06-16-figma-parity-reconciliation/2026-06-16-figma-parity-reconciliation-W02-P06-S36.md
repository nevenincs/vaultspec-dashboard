...
<!-- FRONTMATTER RULES:
     ...
     The S36 and 2026-06-16-figma-parity-reconciliation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rebuild the degradation overlays from their binding frames reading availability from the tiers block and ## Scope

- `frontend/src/app/degradation/` placeholders below are machine-filled
