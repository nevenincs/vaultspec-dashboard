...
<!-- FRONTMATTER RULES:
     ...
     The S54 and 2026-06-16-figma-parity-reconciliation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rebuild the Tune knobs (Spacing, Connection-reach, Clustering) mapped onto the preserved d3-force driver and ## Scope

- `frontend/src/scene/field/forceLayout.ts` placeholders below are machine-filled
