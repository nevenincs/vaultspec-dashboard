...
<!-- FRONTMATTER RULES:
     ...
     The S22 and 2026-06-16-figma-parity-reconciliation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Validate the full Code Connect map parses with zero errors via figma connect parse, leaving publish as the human's gated step and ## Scope
