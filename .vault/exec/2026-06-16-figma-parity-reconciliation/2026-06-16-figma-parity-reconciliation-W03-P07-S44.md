...
<!-- FRONTMATTER RULES:
     ...
     The S44 and 2026-06-16-figma-parity-reconciliation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewrite the circle salience sizing to the engine-served degree-of-interest salience and ## Scope

- `frontend/src/scene/field/salienceEncoding.test.ts` placeholders below are machine-filled
