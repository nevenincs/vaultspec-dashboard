...
<!-- FRONTMATTER RULES:
     ...
     The S42 and 2026-06-16-figma-parity-reconciliation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewrite the node sprites as category-colored circles faithful to the binding Node-items frame and ## Scope
