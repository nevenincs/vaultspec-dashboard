...
<!-- FRONTMATTER RULES:
     ...
     The S45 and 2026-06-16-figma-parity-reconciliation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rewrite the flat-grey edge mesh render faithful to the binding Hero frame connection treatment and ## Scope

- `frontend/src/scene/field/edgeMeshes.ts` placeholders below are machine-filled
