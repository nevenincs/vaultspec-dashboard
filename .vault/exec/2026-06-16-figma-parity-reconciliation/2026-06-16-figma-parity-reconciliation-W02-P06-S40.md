...
<!-- FRONTMATTER RULES:
     ...
     The S40 and 2026-06-16-figma-parity-reconciliation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Rebuild the command palette from its binding frame over the preserved command registry and ## Scope

- `frontend/src/app/palette/CommandPalette.tsx` placeholders below are machine-filled
