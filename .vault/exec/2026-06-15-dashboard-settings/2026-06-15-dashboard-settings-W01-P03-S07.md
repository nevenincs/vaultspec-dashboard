...
<!-- FRONTMATTER RULES:
     ...
     The S07 and 2026-06-15-dashboard-settings-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add the GET /settings/schema route serving the grouped, ordered, described registry through the shared envelope and ## Scope
