...
<!-- FRONTMATTER RULES:
     ...
     The S12 and 2026-06-15-dashboard-settings-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add the effective-value selector resolving scoped-then-global with default fallback and provenance over schema and values and ## Scope

- `frontend/src/stores/server/settingsSelectors.ts` placeholders below are machine-filled
