...
<!-- FRONTMATTER RULES:
     ...
     The S11 and 2026-06-15-dashboard-settings-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add the useSettingsSchema query hook with its query key and invalidation wiring and ## Scope
