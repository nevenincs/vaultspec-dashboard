...
<!-- FRONTMATTER RULES:
     ...
     The S21 and 2026-06-15-dashboard-settings-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Build the number slider control with drag and keyboard input and ## Scope

- `frontend/src/app/settings/controls/NumberControl.tsx` placeholders below are machine-filled
