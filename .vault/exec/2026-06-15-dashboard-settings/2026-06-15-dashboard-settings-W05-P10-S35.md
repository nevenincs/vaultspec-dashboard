...
<!-- FRONTMATTER RULES:
     ...
     The S35 and 2026-06-15-dashboard-settings-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Update theme controller and useTheme tests for the reconcile path preserving no-FOUC and ## Scope

- `frontend/src/platform/theme/themeController.test.ts` placeholders below are machine-filled
