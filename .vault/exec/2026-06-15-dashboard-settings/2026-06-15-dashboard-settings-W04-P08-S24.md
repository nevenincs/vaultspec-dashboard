...
<!-- FRONTMATTER RULES:
     ...
     The S24 and 2026-06-15-dashboard-settings-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Build the SettingsDialog composing the Dialog with categories built from the served schema and effective values and ## Scope
