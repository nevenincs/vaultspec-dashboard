...
<!-- FRONTMATTER RULES:
     ...
     The S33 and 2026-06-15-dashboard-settings-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Reconcile the theme controller to the unified model: localStorage as pre-paint cache, server as authority, cache-then-reconcile on load and ## Scope

- `frontend/src/platform/theme/themeController.ts` placeholders below are machine-filled
