...
<!-- FRONTMATTER RULES:
     ...
     The S37 and 2026-06-15-dashboard-settings-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Run the full lint gate (just dev lint all) to exit 0 including prettier and rustfmt and ## Scope
