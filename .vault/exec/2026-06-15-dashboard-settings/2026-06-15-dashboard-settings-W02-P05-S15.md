...
<!-- FRONTMATTER RULES:
     ...
     The S15 and 2026-06-15-dashboard-settings-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Run the frontend lint and test gate for the stores changes to exit 0 and ## Scope
