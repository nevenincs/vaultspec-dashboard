...
<!-- FRONTMATTER RULES:
     ...
     The S30 and 2026-06-15-dashboard-settings-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add a Settings command to the command palette routing to the dialog and ## Scope
