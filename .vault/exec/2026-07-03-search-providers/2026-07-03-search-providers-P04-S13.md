...
<!-- FRONTMATTER RULES:
     ...
     The S13 and 2026-07-03-search-providers-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Make the document finder a thin consumer of the files-vault provider, deleting its private matcher in favor of the shared utility while keeping its keybinding and focused-plane behavior and ## Scope

- `frontend/src/stores/server/documentSearchController.ts + app/palette/DocumentSearchSurface.tsx` placeholders below are machine-filled
