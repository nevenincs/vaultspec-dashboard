...
<!-- FRONTMATTER RULES:
     ...
     The S20 and 2026-06-14-graph-node-semantics-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The project rule nodes from the rules tree as authority law with active state and ## Scope
