...
<!-- FRONTMATTER RULES:
     ...
     The S04 and 2026-06-14-graph-node-semantics-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The assert authority_class on the document list shape in graph query tests and ## Scope
