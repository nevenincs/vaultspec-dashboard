...
<!-- FRONTMATTER RULES:
     ...
     The S06 and 2026-06-14-graph-node-semantics-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The parse the audit worst-finding severity into a lifecycle max_severity and ## Scope
