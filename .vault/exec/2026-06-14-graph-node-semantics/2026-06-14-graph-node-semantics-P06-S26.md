...
<!-- FRONTMATTER RULES:
     ...
     The S26 and 2026-06-14-graph-node-semantics-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The feed a captured live sample through the client path and assert the fields and ## Scope
