...
<!-- FRONTMATTER RULES:
     ...
     The S19 and 2026-06-14-graph-node-semantics-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The add the rule node kind and its identity prefix and ## Scope

- `engine/crates/engine-model/src/id.rs` placeholders below are machine-filled
