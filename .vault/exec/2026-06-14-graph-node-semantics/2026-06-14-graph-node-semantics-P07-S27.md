...
<!-- FRONTMATTER RULES:
     ...
     The S27 and 2026-06-14-graph-node-semantics-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The run the full lint gate to exit zero across frontend and rust and ## Scope
