...
<!-- FRONTMATTER RULES:
     ...
     The S10 and 2026-06-14-graph-node-semantics-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The add the aggregate collapsibility hint for exec records bound to a parent plan and ## Scope
