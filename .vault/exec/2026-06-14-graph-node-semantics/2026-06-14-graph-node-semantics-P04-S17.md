...
<!-- FRONTMATTER RULES:
     ...
     The S17 and 2026-06-14-graph-node-semantics-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The prove the derivation label is not part of the edge stable key and ## Scope
