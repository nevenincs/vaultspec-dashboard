...
<!-- FRONTMATTER RULES:
     ...
     The S49 and 2026-06-14-graph-representation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Build the RepresentationModePanel control emitting mode intent into the view store and ## Scope

- `frontend/src/app/stage/RepresentationModePanel.tsx` placeholders below are machine-filled
