...
<!-- FRONTMATTER RULES:
     ...
     The S36 and 2026-06-14-graph-representation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add activeRepresentationMode and setRepresentationMode to the view store and ## Scope
