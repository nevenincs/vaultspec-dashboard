...
<!-- FRONTMATTER RULES:
     ...
     The S45 and 2026-06-14-graph-representation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Amend node-canvas ADR body: salience as label-priority input and ## Scope

- `.vault/adr/2026-06-14-dashboard-node-canvas-adr.md` placeholders below are machine-filled
...
- `.vault/adr/2026-06-14-dashboard-node-canvas-adr.md`
