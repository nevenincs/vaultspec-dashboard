...
<!-- FRONTMATTER RULES:
     ...
     The S24 and 2026-06-14-graph-representation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add the measured promotion gate (projection time budget + cluster separation check) and ## Scope

- `frontend/src/scene/field/semanticGate.ts` placeholders below are machine-filled
