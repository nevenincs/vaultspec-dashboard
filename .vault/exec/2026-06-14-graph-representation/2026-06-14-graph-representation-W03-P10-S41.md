...
<!-- FRONTMATTER RULES:
     ...
     The S41 and 2026-06-14-graph-representation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add BubbleSets hull geometry at document LOD and ## Scope

- `frontend/src/scene/field/bubbleSets.ts` placeholders below are machine-filled
