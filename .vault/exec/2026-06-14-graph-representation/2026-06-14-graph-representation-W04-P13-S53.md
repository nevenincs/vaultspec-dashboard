...
<!-- FRONTMATTER RULES:
     ...
     The S53 and 2026-06-14-graph-representation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add render tests for the mode and lens selector controls and ## Scope

- `frontend/src/app/stage/RepresentationModePanel.test.tsx` placeholders below are machine-filled
