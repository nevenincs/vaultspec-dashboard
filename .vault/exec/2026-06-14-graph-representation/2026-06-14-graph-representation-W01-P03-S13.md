...
<!-- FRONTMATTER RULES:
     ...
     The S13 and 2026-06-14-graph-representation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add a consumer test feeding a mock graph sample through adaptGraphSlice asserting new fields survive and ## Scope

- `frontend/src/stores/server/liveAdapters.salience.test.ts` placeholders below are machine-filled
