...
<!-- FRONTMATTER RULES:
     ...
     The S23 and 2026-06-14-graph-representation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add a CPU UMAP-lite projection over embeddings with connectivity fallback for embeddingless nodes and ## Scope

- `frontend/src/scene/field/semanticLayout.ts` placeholders below are machine-filled
