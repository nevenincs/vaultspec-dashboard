...
<!-- FRONTMATTER RULES:
     ...
     The S43 and 2026-06-14-graph-representation-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Unit-test country labels, hull computation, and overlay toggling and ## Scope

- `frontend/src/scene/field/overlays.test.ts` placeholders below are machine-filled
