...
<!-- FRONTMATTER RULES:
     ...
     The S08 and 2026-06-14-graph-node-salience-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Implement linear-time k-core peeling returning per-node coreness over the backbone and ## Scope
