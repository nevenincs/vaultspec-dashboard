...
<!-- FRONTMATTER RULES:
     ...
     The S14 and 2026-06-14-graph-node-salience-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Implement the status-lens activity-burst term over recent temporal-tier edge activity (new exec records and commit-correlation edges in the recent window) and ## Scope
