...
<!-- FRONTMATTER RULES:
     ...
     The S38 and 2026-06-14-graph-node-salience-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Parameterize the useGraphSlice query by active lens, keying the query cache on lens so a lens switch is a re-query and ## Scope
