...
<!-- FRONTMATTER RULES:
     ...
     The S29 and 2026-06-14-graph-node-salience-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add the lens request parameter to the graph query body and parse it, defaulting to the status lens when omitted and ## Scope
