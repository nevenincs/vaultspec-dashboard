...
<!-- FRONTMATTER RULES:
     ...
     The S26 and 2026-06-14-graph-node-salience-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Implement focus folding: mix focus-bias into the lens teleport vector and re-run the warm-started PPR so a-priori minus distance is one computation and ## Scope
