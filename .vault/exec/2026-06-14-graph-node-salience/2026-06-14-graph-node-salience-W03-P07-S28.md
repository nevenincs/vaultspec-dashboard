...
<!-- FRONTMATTER RULES:
     ...
     The S28 and 2026-06-14-graph-node-salience-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Unit-test that a no-focus lens switch is a warm-cache hit and a focus change runs exactly one warm-started PPR pass and ## Scope
