...
<!-- FRONTMATTER RULES:
     ...
     The S36 and 2026-06-14-graph-node-salience-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Add an active-salience-lens view store (status default) distinct from the saved-filter-set lenses store, exposing the active lens and a setter and ## Scope
