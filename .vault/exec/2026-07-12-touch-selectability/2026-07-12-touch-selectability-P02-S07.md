...
<!-- FRONTMATTER RULES:
     ...
     The S07 and 2026-07-12-touch-selectability-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Re-enable text selection on code tree row path text and route the code-file menu through the selection guard and ## Scope
