...
<!-- FRONTMATTER RULES:
     ...
     The S12 and 2026-07-12-touch-selectability-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Re-enable selection on island interior chips and step titles beneath the newly scoped island menu and ## Scope

- `frontend/src/app/islands/NodeInterior.tsx` placeholders below are machine-filled
