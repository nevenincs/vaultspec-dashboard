...
<!-- FRONTMATTER RULES:
     ...
     The S04 and 2026-07-12-touch-selectability-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Route the whole-viewer vault-doc context-menu hijack through the selection guard so selected prose keeps its native menu and ## Scope
