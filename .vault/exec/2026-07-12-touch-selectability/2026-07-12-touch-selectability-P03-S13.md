...
<!-- FRONTMATTER RULES:
     ...
     The S13 and 2026-07-12-touch-selectability-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Re-enable selection on command, document-search, and semantic-search result row data text across the palette surfaces and ## Scope

- `frontend/src/app/palette/` placeholders below are machine-filled
