...
<!-- FRONTMATTER RULES:
     ...
     The S09 and 2026-07-12-touch-selectability-plan placeholders are machine-filled by
...
<!-- STEP RECORD:
     ...
     The Re-enable selection on inspector node title, property values, and edge row labels and guard the node and edge menu opens and ## Scope
