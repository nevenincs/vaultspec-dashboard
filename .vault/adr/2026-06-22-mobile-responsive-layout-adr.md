...
<!-- FRONTMATTER RULES:
     ...
     Replace mobile-responsive-layout with a kebab-case feature tag, e.g. #foo-bar.
...
# `mobile-responsive-layout` adr: `mobile responsive layout` | (**status:** `{proposed|accepted|rejected|deprecated}`)
